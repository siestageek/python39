...
print('국어 : {:03d}, 영어 : {:03d}, 수학 : {:03d}'
      .format(kor, eng, mat))   # 인덱스 생략 가능
print('총점 : {0:d}, 평균 : {1:.1f} ({1:f})'
      .format(tot, avg))   # 특정변수 반복출력 가능

print('총점 : {1:d}, 평균 : {0:.1f} ({0:f})'
      .format(avg, tot))   # 변수의 출력순서 재조정
